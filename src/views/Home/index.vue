    ...
    <div class="banner">
      <el-carousel indicator-position="outside" height="480px">
        <el-carousel-item v-for="(item, i) in banner" :key="i">
          <img class="img1" v-if="item.picUrl" :src="item.picUrl" alt="" />
          <img class="img2 a" v-if="item.picUrl2" :src="item.picUrl2" alt="" />
          <img class="img3 b" v-if="item.picUrl3" :src="item.picUrl3" alt="" />
        </el-carousel-item>
      </el-carousel>
    </div>
